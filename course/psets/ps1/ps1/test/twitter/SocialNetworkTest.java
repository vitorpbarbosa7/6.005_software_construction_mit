...
public class SocialNetworkTest {
    ...
    Map<String, Set<String>> expectedGraph = new HashMap<>();
    expectedGraph.put("neumman", new HashSet<>(Arrays.asList("babbage", "dijkstra"))); // "ada" follows "alan" due to #mit
    expectedGraph.put("dijkstra", new HashSet<>(Arrays.asList("babbage"))); // "alan" follows "ada" due to #mit
